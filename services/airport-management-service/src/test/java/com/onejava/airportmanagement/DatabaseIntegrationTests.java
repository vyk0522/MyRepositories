...
import com.onejava.airportmanagement.docref.AirportRepository;
import com.onejava.airportmanagement.docref.FlightRepository;
...
class DatabaseIntegrationTests {
    ...
    public void beforeEach() {
        ...
        Airport venice = new Airport("7ed990d2-6471-485d-931e-c77729dc0f25", "Venice Airport", "Venice", 30298531);
        ...
        List<Flight> flights = Arrays.asList(flightOne, flightTwo);
    ...
    public void findByMinAircraftNbSeatsShouldWork() {
        ...
        // When
        List<Flight> flights = flightRepository.findByMinAircraftNbSeatsAndDest(minSeats);;
    ...
    public void theCascadeOnSaveShouldWork() {
        // Given
        Airport bucharest = new Airport("02297334-ff56-4380-9004-76cd2a37ea14", "OTP", "Bucharest", 10298531);
        Airport london = new Airport("8d4f79cc-4cec-432c-9efd-8409a9ff7d38", "Heathrow", "London", 90298531);
        ...
        // Then
        Flight dbFlight = flightRepository.findById("ba555186-ec60-4e9f-8462-d4a8aaa1a8ae").get();
        assertNotNull(dbFlight);

        Airport dbLondon = airportRepository.findById("8d4f79cc-4cec-432c-9efd-8409a9ff7d38").get();
        assertNotNull(dbLondon);

        Airport dbBucharest = airportRepository.findById("02297334-ff56-4380-9004-76cd2a37ea14").get();
